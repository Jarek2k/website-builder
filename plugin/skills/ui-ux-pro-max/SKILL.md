...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <your-stack>
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack nextjs
```
